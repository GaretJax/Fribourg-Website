...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_monthcalendarplugin', (
            ...
            ('display_details', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
        ))
        db.send_create_signal('calendars', ['MonthCalendarPlugin'])

        # Adding M2M table for field calendars_to_display on 'MonthCalendarPlugin'
        db.create_table('calendars_monthcalendarplugin_calendars_to_display', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('monthcalendarplugin', models.ForeignKey(orm['calendars.monthcalendarplugin'], null=False)),
            ('calendar', models.ForeignKey(orm['schedule.calendar'], null=False))
        ))
        db.create_unique('calendars_monthcalendarplugin_calendars_to_display', ['monthcalendarplugin_id', 'calendar_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('calendars_monthcalendarplugin_calendars_to_display')
    
    
    models = {
        'calendars.monthcalendarplugin': {
            'Meta': {'object_name': 'MonthCalendarPlugin', 'db_table': "'cmsplugin_monthcalendarplugin'", '_ormbases': ['cms.CMSPlugin']},
            'calendars_to_display': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['schedule.Calendar']"}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'display_details': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'})
        },
        'cms.cmsplugin': {
